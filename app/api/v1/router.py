...
from app.api.v1.tournament_admin_routes import router as tournament_admin_router
from app.api.v1.tournament_result_routes import router as tournament_result_router
